...
export const feeds: Feed[] = [
  ...
  {
    id: 'hallasan-its-1100-west',
    name: { ko: '1100고지 서측', en: '1100 Pass West' },
    mountainId: 'hallasan',
    kind: 'access',
    region: { ko: '제주', en: 'Jeju' },
    provider: { ko: '제주 ITS', en: 'Jeju ITS' },
    officialLabel: { ko: '제주 ITS CCTV 원본', en: 'Jeju ITS CCTV source' },
    officialPage: 'https://www.jejuits.go.kr/jido/mainView.do?DEVICE_KIND=CCTV',
    sourceUrl: '/api/jejuits/stream?deviceId=dba35405-c791-7689-0ea9-2890225acd53',
  },
  {
    id: 'hallasan-its-1100-east',
    name: { ko: '1100고지 동측', en: '1100 Pass East' },
    mountainId: 'hallasan',
    kind: 'access',
    region: { ko: '제주', en: 'Jeju' },
    provider: { ko: '제주 ITS', en: 'Jeju ITS' },
    officialLabel: { ko: '제주 ITS CCTV 원본', en: 'Jeju ITS CCTV source' },
    officialPage: 'https://www.jejuits.go.kr/jido/mainView.do?DEVICE_KIND=CCTV',
    sourceUrl: '/api/jejuits/stream?deviceId=0ce6ae92-c6d2-78ed-cf34-f0c6f119bdca',
  },
  {
    id: 'hallasan-its-seongpanak-south',
    name: { ko: '성판악 남측', en: 'Seongpanak South' },
    mountainId: 'hallasan',
    kind: 'access',
    region: { ko: '제주', en: 'Jeju' },
    provider: { ko: '제주 ITS', en: 'Jeju ITS' },
    officialLabel: { ko: '제주 ITS CCTV 원본', en: 'Jeju ITS CCTV source' },
    officialPage: 'https://www.jejuits.go.kr/jido/mainView.do?DEVICE_KIND=CCTV',
    sourceUrl: '/api/jejuits/stream?deviceId=ecf0c5c5-6cc2-ab81-9e05-62a4cf11c95c',
  },
  {
    id: 'hallasan-its-seongpanak-north',
    name: { ko: '성판악 북측', en: 'Seongpanak North' },
    mountainId: 'hallasan',
    kind: 'access',
    region: { ko: '제주', en: 'Jeju' },
    provider: { ko: '제주 ITS', en: 'Jeju ITS' },
    officialLabel: { ko: '제주 ITS CCTV 원본', en: 'Jeju ITS CCTV source' },
    officialPage: 'https://www.jejuits.go.kr/jido/mainView.do?DEVICE_KIND=CCTV',
    sourceUrl: '/api/jejuits/stream?deviceId=01cfdc49-bb43-c5f1-925e-a10842d52b4e',
  },
  {
    id: 'hallasan-its-eorimok',
    name: { ko: '어리목입구', en: 'Eorimok Entrance' },
    mountainId: 'hallasan',
    kind: 'access',
    region: { ko: '제주', en: 'Jeju' },
    provider: { ko: '제주 ITS', en: 'Jeju ITS' },
    officialLabel: { ko: '제주 ITS CCTV 원본', en: 'Jeju ITS CCTV source' },
    officialPage: 'https://www.jejuits.go.kr/jido/mainView.do?DEVICE_KIND=CCTV',
    sourceUrl: '/api/jejuits/stream?deviceId=9261f807-613e-5feb-e772-4b36d255fe27',
  },
  {
    id: 'hallasan-its-donnaeko',
    name: { ko: '돈내코입구', en: 'Donnaeko Entrance' },
    mountainId: 'hallasan',
    kind: 'access',
    region: { ko: '제주', en: 'Jeju' },
    provider: { ko: '제주 ITS', en: 'Jeju ITS' },
    officialLabel: { ko: '제주 ITS CCTV 원본', en: 'Jeju ITS CCTV source' },
    officialPage: 'https://www.jejuits.go.kr/jido/mainView.do?DEVICE_KIND=CCTV',
    sourceUrl: '/api/jejuits/stream?deviceId=e5b35556-dfba-01d8-598d-79c8b4f497f4',
  },
  {
    id: 'hallasan-its-bulgeunoreum',
    name: { ko: '붉은오름입구', en: 'Bulgeun Oreum Entrance' },
    mountainId: 'hallasan',
    kind: 'access',
    region: { ko: '제주', en: 'Jeju' },
    provider: { ko: '제주 ITS', en: 'Jeju ITS' },
    officialLabel: { ko: '제주 ITS CCTV 원본', en: 'Jeju ITS CCTV source' },
    officialPage: 'https://www.jejuits.go.kr/jido/mainView.do?DEVICE_KIND=CCTV',
    sourceUrl: '/api/jejuits/stream?deviceId=9315fd0a-9aac-d1fc-e949-c4057052207a',
  },
  {
